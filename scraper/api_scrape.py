...
if __name__ == "__main__":
    ...
    head_sheet(json) 
    send_mails('abdulkabirbadru@gmail.com', 'abdulkabiropeyemi7@gmail.com', 'Job Postings','Please, find the attached for your reference', attach_files= [r"C:\Users\Kaybee\Videos\web_scrapers\scraper\Jobs.xls"])